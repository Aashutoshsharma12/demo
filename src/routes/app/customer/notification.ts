...
import notificationController from '@controllers/customer/notification';
...
/////////////////////// update_status ///////////////////////
router.post(p.update, verifyAuthToken, checkRole(['Customer']), async (req: any, res: Response) => {
...
/////////////////////// get status ///////////////////////
router.get(p.get, verifyAuthToken, checkRole(['Customer']), async (req: any, res: Response) => {
...
/////////////////////// Notification list ///////////////////////
router.get(p.list, verifyAuthToken, checkRole(['Customer']), async (req: any, res: Response) => {
